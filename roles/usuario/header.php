...
<div class="header">
    ...
    <div class="menu">
        ...
        <a href="#" class="boton" onclick="toggleHistorialPanel(event)">Historiales</a>
    </div>
    <!-- Notificaciones -->
    ...
    <nav class="menu-hamburguesa" id="menuHamburguesa">
        <button class="close-hamburger" onclick="toggleHamburguesa()">×</button>
        ...
        <ul>
            ...
            <li>
                <a href="<?= BASE_URL ?>/includes/salir" class="logout-hamburguesa">
                    <i class="bi bi-box-arrow-right"></i> Cerrar Sesión
                </a>
            </li>
        </ul>
    </nav>
    <!-- Panel de Historiales -->
    <div id="historialPanel" class="historial-panel">
        <button class="close-panel" onclick="toggleHistorialPanel(event)">×</button>
        <ul>
            <li><a href="<?= BASE_URL ?>/roles/usuario/historiales/ver_soat">Historial de SOAT</a></li>
            <li><a href="<?= BASE_URL ?>/roles/usuario/historiales/ver_tecnomecanica">Historial de Tecnomecánica</a></li>
            <li><a href="<?= BASE_URL ?>/roles/usuario/historiales/ver_licencia">Historial de Licencia de Conducción</a></li>
            <li><a href="<?= BASE_URL ?>/roles/usuario/historiales/ver_llantas">Historial de Llantas</a></li>
            <li><a href="<?= BASE_URL ?>/roles/usuario/historiales/ver_mantenimiento">Historial de Mantenimiento</a></li>
        </ul>
    </div>
</div>
<!-- Modal de perfil -->
...
.historial-panel .close-panel:hover {
    color: #b71c1c;
}
...
.panel-notificaciones {
    ...
    max-height: 350px;
    overflow-y: auto;
    background: linear-gradient(135deg, #fff, #f5f5f5 80%);
...
// Panel de Historiales
function toggleHistorialPanel(event) {
    event.preventDefault();
    event.stopPropagation();
    const panel = document.getElementById('historialPanel');
    panel.classList.toggle('open');
    if (panel.classList.contains('open')) {
        document.addEventListener('click', closeHistorialPanelOnOutsideClick);
    } else {
        document.removeEventListener('click', closeHistorialPanelOnOutsideClick);
    }
}

function closeHistorialPanelOnOutsideClick(event) {
    const panel = document.getElementById('historialPanel');
    if (panel && !panel.contains(event.target) && !event.target.classList.contains('boton')) {
